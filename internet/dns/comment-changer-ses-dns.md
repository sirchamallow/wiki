...
* Changer ses DNS sur **Android** : [**DNS66**](https://f-droid.org/packages/org.jak_linux.dns66/) \(F-Droid\), [**DNS Changer**](https://play.google.com/store/apps/details?id=com.frostnerd.dnschanger&hl=fr) \(Google Play\), [Blokada](https://github.com/blokadaorg) \(GitHub\)
