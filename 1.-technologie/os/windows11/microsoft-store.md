---
description: Liste d'applications disponibles depuis Microsoft Store
icon: microsoft
---
...
Quelques avantages à utiliser le téléchagement/installation de logiciels depuis le Microsoft Store

* **Sécurité** : applications vérifiées par Microsoft → moins de malware
* **Installation simple** : téléchargement en un clic, sans configuration
* **Mises à jour automatiques** : toujours à jour sans intervention
* **Désinstallation propre** : pas de fichiers résiduels
* **Centralisation** : gestion des apps dans un seul outil
* **Moins de logiciels indésirables** : pas de bundles ou pubs cachées

### Navigateurs

{% embed url="https://apps.microsoft.com/detail/XP99GVQDX7JPR4" %}

{% embed url="https://apps.microsoft.com/detail/9NZVDKPMR9RD?h" %}

{% embed url="https://apps.microsoft.com/detail/XP8C9QZMS2PC1T?" %}

{% embed url="https://apps.microsoft.com/detail/XPFFTQ037JWMHS?" %}

### Jeux

{% embed url="https://apps.microsoft.com/detail/XP99VR1BPSBQJ2" %}
...
{% embed url="https://apps.microsoft.com/detail/xpdc2rh70k22mn" %}

{% embed url="https://apps.microsoft.com/detail/xp89119p9f2pcq" %}
...
{% embed url="https://apps.microsoft.com/detail/9P6RC76MSMMJ" %}

{% embed url="https://apps.microsoft.com/detail/9WZDNCRFJ15T" %}

{% embed url="https://apps.microsoft.com/detail/9NM4T8B9JQZ1" %}

{% embed url="https://apps.microsoft.com/detail/9NXQXXLFST89" %}

### Utilitaires

{% embed url="https://apps.microsoft.com/detail/9np83lwlpz9k" %}
